...
%include "./source/stdio.inc"			; basic i/o routines
%include "./source/Gdt.inc"			; Gdt routines
%include "./source/A20.inc"			; A20 enabling
%include "./source/Fat12.inc"			; FAT12 driver.
...
LoadingMsg db 0x0D, 0x0A, "Searching for ACos kernel...", 0x00
msgFailure db 0x0D, 0x0A, "ERROR: CAN NOT FIND KERNEL.SYS. Press Any Key to Reboot", 0x0D,0x0A,0x00
